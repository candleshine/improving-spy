...
- `chat()`: Have a conversation with the agent
...
class MyTool(Tool):
    ...
    name: str = "my_tool"
    description: str = "Performs a specific task"
...
# Send messages
response1 = chat.send("Hello! Can you help me with some calculations?")
response2 = chat.send("What's 42 divided by 6?")
response3 = chat.send("Now can you process this data: [{'value': 10}, {'value': 20}, {'value': 30}] with operation 'sum'?")
